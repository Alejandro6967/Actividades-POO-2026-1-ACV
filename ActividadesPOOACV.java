...
public class ActividadesPOOACV { //este es el programa general
    
    public static void main (String[] args) {
        
        //inicio
        int edadjuan, edadalberto, edadana, edadmama; //Crea otras tres cajas para # enteros, vacías
        ...
        //trae a juan y opera y usa la caja vacía para guardar el resultado
        edadalberto = (2*edadjuan)/3; 
        edadana=(4*edadjuan)/3; //Se guarda en la caja de edadana.
